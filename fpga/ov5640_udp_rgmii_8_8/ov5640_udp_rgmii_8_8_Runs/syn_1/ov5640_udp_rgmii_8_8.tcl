...
set rc [catch {
  ...
  open_project {ov5640_udp_rgmii_8_8.prj}
  commit_param -step design
  elaborate -top {ov5640_udp_rgmii}
  export_db {ov5640_udp_rgmii_8_8_elaborate.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  ...
  read_adc ../../ov5640_udp_rgmii.adc
  optimize_rtl
  report_area -file ov5640_udp_rgmii_8_8_rtl.area
  export_db {ov5640_udp_rgmii_8_8_rtl.db}
} RESULT]
if {$rc} {
  step_error opt_rtl
  return -code error $RESULT
...
set rc [catch {
  ...
  optimize_gate -maparea ov5640_udp_rgmii_8_8_gate.area
  legalize_phy_inst
  update_timing
  export_db {ov5640_udp_rgmii_8_8_gate.db}
  report_timing_status -file ov5640_udp_rgmii_8_8_gate.ts
} RESULT]
if {$rc} {
  step_error opt_gate
  return -code error $RESULT
